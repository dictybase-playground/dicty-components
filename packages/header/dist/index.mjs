...
var import_prop_types, _excluded, SwitchUnstyled;
  ...
  "../../node_modules/@mui/base/SwitchUnstyled/SwitchUnstyled.js"() {
    ...
    SwitchUnstyled = /* @__PURE__ */ React11.forwardRef(function SwitchUnstyled2(props, ref) {
      ...
      return /* @__PURE__ */ _jsxs(Root, _extends({
        ...
        })), /* @__PURE__ */ _jsx(Input2, _extends({}, getInputProps(inputProps), {
...
import { createContext as createContext2, useContext as useContext2, forwardRef as forwardRef2, createElement, Fragment } from "react";
var isBrowser3, hasOwnProperty, EmotionCacheContext, CacheProvider, withEmotionCache, ThemeContext, typePropName, labelPropName, Noop, Emotion;
var init_emotion_element_fc314d24_esm = __esm({
  "../../node_modules/@emotion/react/dist/emotion-element-fc314d24.esm.js"() {
    ...
    EmotionCacheContext = /* @__PURE__ */ createContext2(typeof HTMLElement !== "undefined" ? /* @__PURE__ */ emotion_cache_esm_default({
      key: "css"
    }) : null);
    if (process.env.NODE_ENV !== "production") {
    ...
    Emotion = /* @__PURE__ */ withEmotionCache(function(props, cache, ref) {
      ...
      var serialized = serializeStyles(registeredStyles, void 0, useContext2(ThemeContext));
...
import { createElement as createElement2, useContext as useContext3, useRef as useRef5, useLayoutEffect as useLayoutEffect2, Fragment as Fragment2 } from "react";
...
var import_extends10, import_hoist_non_react_statics, pkg, warnedAboutCssPropForGlobal, Global, classnames, Noop3, ClassNames, isBrowser5, isJest, globalContext, globalKey;
var init_emotion_react_esm = __esm({
  "../../node_modules/@emotion/react/dist/emotion-react.esm.js"() {
    ...
    Global = /* @__PURE__ */ withEmotionCache(function(props, cache) {
      ...
      var serialized = serializeStyles([styles], void 0, useContext3(ThemeContext));
      if (!isBrowser3) {
        var _ref;
        var serializedNames = serialized.name;
    ...
    ClassNames = /* @__PURE__ */ withEmotionCache(function(props, cache) {
      ...
      var content = {
        css,
        cx,
        theme: useContext3(ThemeContext)
      };
...
import { useContext as useContext4, createElement as createElement3, Fragment as Fragment3 } from "react";
var testOmitPropsOnStringTag, testOmitPropsOnComponent, getDefaultShouldForwardProp, composeShouldForwardProps, ILLEGAL_ESCAPE_SEQUENCE_ERROR2, isBrowser4, Noop5, createStyled, emotion_styled_base_esm_default;
...
import "react";
var import_extends12, tags, newStyled, emotion_styled_esm_default;
...
var import_prop_types3, _excluded10, useUtilityClasses, SvgIconRoot, SvgIcon, SvgIcon_default;
var init_SvgIcon = __esm({
  "../../node_modules/@mui/material/SvgIcon/SvgIcon.js"() {
    ...
    SvgIcon = /* @__PURE__ */ React17.forwardRef(function SvgIcon2(inProps, ref) {
      ...
      return /* @__PURE__ */ _jsxs2(SvgIconRoot, _extends({
        as: component,
        ...
        children: [children, titleAccess ? /* @__PURE__ */ _jsx2("title", {
...
function createSvgIcon(path, displayName) {
  const Component = (props, ref) => /* @__PURE__ */ _jsx3(SvgIcon_default, _extends({
...
var Header = (_a) => {
  ...
  return /* @__PURE__ */ React.createElement(MuiThemeProvider, {
    theme: customTheme
  }, /* @__PURE__ */ React.createElement(HeaderContainer, __spreadValues({
    links: children
  }, rest)));
};
...
var headerDataLogin = [
  ...
  {
    url: "/downloads",
    icon: /* @__PURE__ */ React.createElement(FileDownloadIcon, {
      fontSize: "large"
    }),
    text: "Downloads",
    isNextLink: true
  ...
  {
    url: "/login",
    icon: /* @__PURE__ */ React.createElement(import_Login.default, {
      fontSize: "large"
    }),
    text: "Login",
    isNextLink: true
...
var headerDataLogout = [
  ...
  {
    url: "/logout",
    icon: /* @__PURE__ */ React.createElement(import_Logout.default, {
      fontSize: "large"
    }),
    text: "Logout",
    isNextLink: true
